...
| 🤖 **AI Security Brief** | Generate an AI-powered human-readable summary using Grok AI |
...
When you run the app for the very first time, it will prompt you for a **Grok API Key**.
- This key is required for the "AI Security Brief" feature.
- It takes 30 seconds to get a key from [xAI Console](https://console.x.ai/).
